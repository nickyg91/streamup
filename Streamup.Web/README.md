...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.Streamup.Web.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/SoftwareAteliers.Streamup.Web/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.Streamup.Web`
